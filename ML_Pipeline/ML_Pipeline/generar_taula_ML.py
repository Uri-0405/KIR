...
if len(sys.argv) > 2:
    ...
    FILE_GENETIC = '..//Results_Processed/MalaltsExcels/RESULTATS_T1K_NETS_TALL_MALALTS_68.xlsx'
    OUTPUT_FILE = '../Results_Processed/Taula_imputs_ml.xlsx' # NOM NOU

# Ruta a la base de dades clínica
FILE_CLINIC = '../Data_Clinical/CML Clinical DB.xlsx'
